...
- **Portrait** — Norm illustrated via OpenClaw `image_generate` using Grok Imagine (`xai/grok-imagine-image`)
...
| Portraits | Grok Imagine (`xai/grok-imagine-image`) via OpenClaw `image_generate` → Tinify-optimized via git hooks on push |
